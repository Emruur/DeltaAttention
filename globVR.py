...
packing_mode = "delta"    # "delta" | "random" | "periodic" — controls which tokens become packed anchors
target_keep_rate = 0.5    # fraction of tokens to keep as anchors (used by random and periodic modes)
