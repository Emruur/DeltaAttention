...
\caption{Two consecutive inner-loop iterations for $Q$-block 2. Left: $K_1$ and $V_1$ produce tile $S_{21}$, accumulated into $O_2$. Right: $K_2$ and $V_2$ produce tile $S_{22}$, accumulated into $O_2$.}
